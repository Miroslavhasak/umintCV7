...
3. graf priebehu regulovanej veličiny a žiadanej hodnoty, samostatne pre všetky tri pracovné body (a, b, c),  
4. graf priebehu riadiacej veličiny pre všetky tri pracovné body. Všetky ostatné podmienky experimentu sú rovnaké, ako v predchádzajúcom zadaní.
   
2. Grafy z úlohy 1 porovnajte s nasledovným experimentom: Navrhnite PID regulátor iba 
pre pracovný bod a). Tento regulátor použite aj pre riadenie systému s koeficientami b) 
a c).  Rovnako, ako v úlohe 1 vykreslite všetky tri obrázky, porovnajte ich navzájom 
s úlohou 1 a urobte diskusiu.
